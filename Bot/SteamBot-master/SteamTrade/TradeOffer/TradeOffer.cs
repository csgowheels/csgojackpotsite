    ...
    public class TradeOffer
    {
            ...
            if (offer.ItemsToGive != null)
            {
                foreach (var asset in offer.ItemsToGive)
                {
                   ...
                   /* tradeAsset.CreateItemAsset(Convert.ToInt64(asset.AppId), Convert.ToInt64(asset.ContextId),
                    ...
                    // Added by SRInfoway
                    tradeAsset.CreateItemAsset(Convert.ToInt64(asset.AppId), Convert.ToInt64(asset.ContextId),
                        Convert.ToInt64(asset.AssetId), Convert.ToInt64(asset.Amount), Convert.ToInt64(asset.ClassId), Convert.ToInt64(asset.InstanceId));
        ...
        public class TradeStatusUser
        {
            ...
            public class TradeAsset : IEquatable<TradeAsset>
            {
                ...
                //[JsonProperty("classid")] // Added by SRInfoway
                public long ClassId { get; set; }

                //[JsonProperty("instanceid")] // Added by SRInfoway
                ...
                public void CreateItemAsset(long appId, long contextId, long assetId, long amount, long classId, long instanceId)
                {
                    this.AppId = appId;
                    this.ContextId = contextId;
                    this.AssetId = assetId;
