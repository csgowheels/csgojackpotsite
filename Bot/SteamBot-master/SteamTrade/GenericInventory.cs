...
namespace SteamTrade
{
    ...
    public class GenericInventory
    {
        ...
        public Dictionary<string, ItemDescription> _descriptions = new Dictionary<string, ItemDescription>();
        public Dictionary<ulong, Item> _items = new Dictionary<ulong, Item>();
                        ...
                        foreach (var class_instance in description)// classid + '_' + instenceid 
                        {
                            ...
                            _descriptions.Add("" + (class_instance.classid ?? '0') + "_" + (class_instance.instanceid ?? '0'),
                                new ItemDescription()
                                {
                                    ...
                                    name_hash = class_instance.market_hash_name,
