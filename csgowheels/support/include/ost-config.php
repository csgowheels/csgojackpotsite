...
define('SECRET_SALT','0vc0i1W4Kfx0mAaNv6bItNfONORWIyZ5');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','mohamedorkhan@hotmail.com');
...
define('DBNAME','csgowhee_csgo');
define('DBUSER','csgowhe1_axe');
define('DBPASS','csgowhe1_csgowhee');
